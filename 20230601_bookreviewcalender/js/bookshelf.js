...
let i =0;
for(let bookItem of bookItems){//.book-item 하나씩 가져오자
    const bookItemImg = bookItem.getElementsByTagName("img")[0];//.book-item >img 0번째 가져오자
    bookItemImg.src  = books[i].img;//거기서 data.js 에사 데어터 가져와 넣자
    i++;
}
